...
def get_standard_types(language: str) -> set:
    ...
    language_lower = language.lower()
    if language_lower == "python":
        return PYTHON_STANDARD_TYPES | COMMON_METHOD_NAMES
    elif language_lower in ("csharp", "c#"):
        return CSHARP_STANDARD_TYPES | COMMON_METHOD_NAMES
    elif language_lower == "javascript":
        return JAVASCRIPT_STANDARD_TYPES | COMMON_METHOD_NAMES
    elif language_lower == "typescript":
        return TYPESCRIPT_STANDARD_TYPES | COMMON_METHOD_NAMES
    else:
        return COMMON_METHOD_NAMES.copy()
